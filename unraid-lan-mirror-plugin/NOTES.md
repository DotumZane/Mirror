...
- Push to GitHub, update both Unraid servers to `0.7.2`, and check the remote sync log.
...
- Versioned package build exists at `packages/mirror-0.7.2.txz`.
...
2. On both Unraid servers, update Mirror to `0.7.2`.
...
- Next suggested task: Push local commits to GitHub, update both Unraid servers to `0.7.2`, click Start on the Master, and check Recent Log.
