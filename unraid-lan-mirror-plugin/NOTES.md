...
- Push to GitHub, update both Unraid servers to `0.9.4`, and review the simplified LAN Setup tab.
...
- Versioned package build exists at `packages/mirror-0.9.4.txz`.
...
2. On both Unraid servers, update Mirror to `0.9.4`.
...
- Next suggested task: Push local commits to GitHub, update both Unraid servers to `0.9.4`, and review the LAN Setup tab.
