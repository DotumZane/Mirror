...
- Push to GitHub, update both Unraid servers to `V1.00.02`, and test multiple share pairs.
...
- Versioned package build exists at `packages/mirror-V1.00.02.txz`.
...
2. On both Unraid servers, update Mirror to `V1.00.02`.
...
- Next suggested task: Push local commits to GitHub, update both Unraid servers to `V1.00.02`, and test multiple share pairs.
