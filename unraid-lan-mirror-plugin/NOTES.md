...
- Push to GitHub, update both Unraid servers to `0.6.0`, and confirm completed invite details no longer show after pairing.
...
- Versioned package build exists at `packages/mirror-0.6.0.txz`.
...
2. On both Unraid servers, update Mirror to `0.6.0`.
...
- Next suggested task: Push local commits to GitHub, update both Unraid servers to `0.6.0`, verify Peer Link status without invite-detail noise, then implement master-pushed remote configuration.
