...
- Push to GitHub, update both Unraid servers to `0.9.0`, and test daemon interval `0`.
...
- Versioned package build exists at `packages/mirror-0.9.0.txz`.
...
2. On both Unraid servers, update Mirror to `0.9.0`.
...
- Next suggested task: Push local commits to GitHub, update both Unraid servers to `0.9.0`, and test daemon interval `0`.
